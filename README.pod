=head1 cdfs-sim: The XMM-CDFS simulator
...
refer to the paper: L<Ranalli, Comastri, Carrera, Vignali et al., 2013,
Astronomy and Astrophysics 555, A42|http://cdsads.u-strasbg.fr/abs/2013A%26A...555A..42R>.
...
Open Xspec (*), define any model, and give the
commands:
...
=head3 > What do you use to calculate the PSF?
...
=head3 > What input does the simulator need?
...
=head3 > What output does it provide?

The output is an event file, which can be processed (hopefully) like
any other XMM-Newton event file.


=head3 > Can I use this simulator for Chandra/eRosita/Athena/any other X-ray
  mission?
...
=head3 > What do you use for the input spectrum?
...
=head3 > Which kind of X-ray events does this program simulate?
...
=head3 > Can I use this program for my research?
...
I. Georgantopoulos, K. Iwasawa, V. Mainieri, "B<The XMM-Newton deep
survey in the Chandra Deep Field South. III. Point source catalogue
and number counts in the hard X-rays>", 2013, to appear on Astronomy
and Astrophysics

=head3 > Can I modify this program?
